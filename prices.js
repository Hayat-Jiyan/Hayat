...
(function () {
  ...
  const numberedItems = [
    ...
    { number: "6", name: "Havuç Ezme", price: "4,90 €" },
    { number: "7", name: "Muhammara", price: "5,90 €" },
    { number: "8", name: "Haydari Ezme", price: "5,80 €" },
    { number: "9", name: "Gefüllte Weinblätter", price: "7,60 €" },
    { number: "10", name: "Türkischer Teller", price: "9,50 €" },
    { number: "11", name: "Kalte Platte", price: "10,90 €" },
    { number: "12", name: "Auberginen Ezme", price: "5,80 €" },
    { number: "13", name: "Gebratenes Gemüse", price: "8,50 €" },
    { number: "14", name: "Antep-Ezme", price: "5,50 €" },
    { number: "15", name: "Humuz", price: "5,90 €" },
    { number: "16", name: "HAYAT-Vorspeisenteller", price: "11,90 €" },
    ...
    { number: "29", name: "Tomaten-Joghurt-Salat", price: "8,80 €" },
    { number: "91", name: "Iskender Kebap", price: "12,90 €" },
    { number: "92", name: "Döner mit Reis und Joghurt", price: "12,90 €" },
    { number: "93", name: "Fleischteller (Döner, Lamms pieß, Köfte)", price: "15,90 €" },
    { number: "36", name: "Zucchinipuffer", price: "11,50 €" },
    { number: "37", name: "Humuz-Spinat-Köfte (veg.)", price: "11,50 €" },
    { number: "38", name: "Teigtaschen mit Gemüse", price: "11,90 €" },
    ...
    { number: "48", name: "Gemüsepfanne", price: "10,50 €" },
    ...
    { number: "57", name: "Türkische Wurst mit Paprika &amp; Salat", price: "11,90 €" },
    { number: "59", name: "Şiş mit Lammfleisch", price: "13,90 €" },
    { number: "60", name: "Hähnchenspieß", price: "13,50 €" },
    { number: "62", name: "Köfte", price: "13,50 €" },
    { number: "63", name: "Köfte mit Hirtenkäsefüllung", price: "14,90 €" },
    { number: "64", name: "Adana Şiş", price: "13,50 €" },
    { number: "65", name: "Adana Şiş mit Joghurtsauce", price: "14,00 €" },
    { number: "66", name: "Tomaten-Kebab", price: "14,50 €" },
    { number: "67", name: "Pirzola (Lammkoteletts)", price: "16,90 €" },
    { number: "68", name: "Fleischplatte", price: "16,90 €" },
    ...
    { number: "87", name: "Baklava (3 Stück, mit Sahne, Zimt und Walnuss)", price: "5,50 €" },
  ...
  const namedItems = [
    ...
    { name: "Säfte / Saftschorle", price: "3,00 € / 4,50 €" },
    ...
    { name: "Montepulciano d'Abruzzo", price: "4,80 €" },
    { name: "Merlot (enthält Sulfite)", price: "4,80 €" },
